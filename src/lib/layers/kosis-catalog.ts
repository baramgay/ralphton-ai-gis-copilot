...
export const KOSIS_WELFARE_LAYER = kosisLayer(
  ...
  [
    ...
    },
    {
      ...
      /*
       * 「어르신」이 없어서 「혼자 사시는 어르신이 많은 지역」이 화재율·교통사고율보다
       * 낮게 나왔다(정답 6위, 1위와의 차이 0.001 — 옆 문서 길이가 조금만 바뀌어도 뒤집힌다).
       * 노인을 부르는 말이 하나뿐이면 그 말로 묻지 않은 질의는 답을 못 찾는다.
       */
      triggers: ["독거노인", "홀몸노인", "독거노인가구", "혼자 사는 노인", "혼자 사는 어르신", "홀몸 어르신", "독거 어르신"],
    },
    {
      key: "foreign_rate",
      label: "인구 천명당 등록외국인",
