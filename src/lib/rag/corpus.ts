...
export const CURATED_RAG_CORPUS: RagChunk[] = [
  ...
  /*
   * 창구를 묻는 질의에 답할 곳이 코퍼스에 없었다. 「경남빅데이터허브플랫폼에 뭐가 있냐」는
   * 이 도구를 쓰는 사람이 실제로 묻는 말인데, 기관별 청크는 SKT·NH·KCB를 따로 말할 뿐
   * 그 셋을 묶은 창구 이름을 한 번도 부르지 않았다.
   *
   * 지표 청크마다 창구 이름을 심지 않는다 — 모든 문서에 같은 낱말이 들어가면 그 낱말로는
   * 아무것도 못 가르고, 문서만 길어져 다른 질의의 순위가 흔들린다. 창구는 여기 한 곳에서만
   * 말한다.
   */
  {
    id: "gn-bigdata-hub",
    title: "경남빅데이터허브플랫폼",
    body: "이 도구가 쓰는 민간데이터의 제공 창구는 경상남도가 운영하는 경남빅데이터허브플랫폼입니다. SKT 이동통신(생활인구·주야간인구·이동인구), NH농협카드 소비(카드소비·소비주체·시간대 소비·업종구성·생활업종), KCB 신용정보(소득·신용·거주이동·통근·500m 격자), 경상남도 기업정보를 여기서 받았습니다. 주민등록 인구·의료기관·국가통계포털(KOSIS) 자료는 각자의 창구에서 직접 받으므로 이 창구에 속하지 않습니다.",
    tags: ["source", "hub", "SKT", "NH", "KCB", "민간데이터"],
    keywords: [
      "경남빅데이터허브플랫폼",
      "빅데이터허브",
      "허브플랫폼",
